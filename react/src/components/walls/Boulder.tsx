    ...
    <>
      <div className="flex justify-center">
        <div className={"container"}>
          <header className={"bg-base-200 sticky top-0 z-10 p-2"}>
          ...
          <aside>
            <form onSubmit={e => {
              ...
              <input type="text" placeholder="Your feedback..." className="input input-bordered w-full" />
              <div className="flex my-1">
                <p className={"flex-auto"}>
                  Finished as:
                  <button className={"btn btn-outline btn-sm ml-1"}>Flash</button>
                  <button className={"btn btn-outline btn-sm ml-1"}>Project</button>
                </p>

                <p>Or just:
                  <button className={"btn btn-primary btn-sm ml-1"}>Leave Feedback</button>
                </p>
              </div>
            </form>
          </aside>
